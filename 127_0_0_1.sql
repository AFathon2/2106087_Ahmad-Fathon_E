...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 11:48 AM
...
--
CREATE DATABASE IF NOT EXISTS `2106013_jalal` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `2106013_jalal`;
...
--
CREATE DATABASE IF NOT EXISTS `2106087_ahmad` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `2106087_ahmad`;
...
INSERT INTO `tamu` (`idtamu`, `nmtamu`, `email`) VALUES
(10, 'Jalaludin Malik', '2106013@itg.ac.id');
...
--
ALTER TABLE `tamu`
  MODIFY `idtamu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- Database: `db_gudang`
--
CREATE DATABASE IF NOT EXISTS `db_gudang` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_gudang`;
...
('root', '2023-09-26 12:26:55', '{\"Console\\/Mode\":\"collapse\"}');
